...
Bundle.prototype.matchLog = function(logStmt, userdata) {
    ...
    if (logMatched){
        this.eventQuery.emit('matched-log', {"log": logStmt, "matchedQid": this.bundleName + "_" + matchedQid, "userdata": userdata})
    }
}
