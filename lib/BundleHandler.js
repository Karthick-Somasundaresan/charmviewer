...
BundleHandler.prototype.loadFromUserData = function (){
    ...
    if(this.userDataLocation !== undefined && this.userDataLocation !== null){
        bundleJsonObj = loadJsonFromFile(this.userDataLocation + "/savedBundle.json")
        let bundleLst = bundleJsonObj["bundleObjLst"]
        let cnt = 0
        if(bundleLst !== undefined && bundleLst.length > 0) {
...
BundleHandler.prototype.updateUserData = function() {
    if (this.userDataLocation !== undefined && this.userDataLocation !== null ){
        ...
        fs.writeFileSync(this.userDataLocation + "/savedBundle.json",JSON.stringify(exportObj))
    }
}
