...
*/
BundleHandler.prototype.importBundle = function(bundleObj, saveBundle = true) {
...
BundleHandler.prototype.getEnabledBundleName = function() {
    for (const bundleName in this.bundleCollection) {
        if (this.bundleCollection.hasOwnProperty(bundleName)) {
            if(this.bundleCollection[bundleName].getEnforcement()) {
                return bundleName
            }
...
BundleHandler.prototype.enableBundle = function(bundleName, status) {
    for (const bundleKey in this.bundleCollection) {
        // console.log("bundleKey: ", bundleKey, "|| bundleName: ", bundleName, "||")
        // if (this.bundleCollection.hasOwnProperty(bundleKey)) {
            const element = this.bundleCollection[bundleKey];
